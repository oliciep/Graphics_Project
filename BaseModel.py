...
class BaseModel:
    ...
    def __init__(self, scene, M=poseMatrix(), mesh=Mesh(), color=None, primitive=GL_TRIANGLES, visible=True):
        '''
        Initialises the base model data for the model, including mesh colour and matrices.
        '''
